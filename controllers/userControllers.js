                ...
                if (req.body.password) {
                    return bcrypt.hash(req.body.password, 10)
                        .then((hash) => {
                            ...
                            // On empêche l'utilisateur de mettre à jour son pseudo
                            req.body.pseudo = result.pseudo
...
module.exports = {createUser, findAllUsers, findUserByPk, updateUser, deleteUser}